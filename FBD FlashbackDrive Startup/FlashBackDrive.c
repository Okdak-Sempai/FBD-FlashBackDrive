...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    writeToLog(currentLogsFile, L"FBD FlashBackDrive Startup Return", L"0");
    MessageBox(NULL, L"The Startup backup for the specified Drives has successfully ended.\nThis is Located in the [FBD FlashBackDrive Startup] Folder.", L"FBD FlashBackDrive", MB_ICONINFORMATION);
    return 0;
}
